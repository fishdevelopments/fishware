...
class GUIScreen : Screen(Text.literal("GUIScreen")) {
  ...
  init {
    ...
    style.setColor(
        ImGuiCol.TextDisabled, 0.4980392158031464f, 0.4980392158031464f, 0.4980392158031464f, 1.0f)
    style.setColor(
        ImGuiCol.WindowBg, 0.09803921729326248f, 0.09803921729326248f, 0.09803921729326248f, 0.9f)
    ...
    style.setColor(
        ...
        0.5400000214576721f)
    style.setColor(
        ImGuiCol.FrameBgActive, 0.2000000029802322f, 0.2196078449487686f, 0.2274509817361832f, 1.0f)
    ...
    style.setColor(
        ImGuiCol.MenuBarBg, 0.1372549086809158f, 0.1372549086809158f, 0.1372549086809158f, 1.0f)
    style.setColor(
    ...
    style.setColor(
        ...
        0.5400000214576721f)
    style.setColor(
        ImGuiCol.CheckMark, 0.3294117748737335f, 0.6666666865348816f, 0.8588235378265381f, 1.0f)
    style.setColor(
        ImGuiCol.SliderGrab,
        0.3372549116611481f,
        0.3372549116611481f,
    ...
    style.setColor(
        ...
        0.5400000214576721f)
    style.setColor(
        ImGuiCol.ButtonActive, 0.2000000029802322f, 0.2196078449487686f, 0.2274509817361832f, 1.0f)
    ...
    style.setColor(
        ImGuiCol.TabHovered, 0.1372549086809158f, 0.1372549086809158f, 0.1372549086809158f, 1.0f)
    style.setColor(
        ImGuiCol.TabActive,
        0.2000000029802322f,
        0.2000000029802322f,
